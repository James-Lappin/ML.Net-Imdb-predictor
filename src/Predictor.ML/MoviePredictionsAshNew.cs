...
namespace Predictor.ML.Ash.New
{
    ...
    public class MoviePredictionsAshNew
    {
        ...
        public static (IDataView training, IDataView test) LoadData(MLContext mlContext)
        {
            ...
            // <SnippetLoadData>
            var trainingDataPath = Path.Combine(Environment.CurrentDirectory, "Data", Path.Combine(AppDomain.CurrentDomain.BaseDirectory + "recommendation-ratings-train.csv"));
            var testDataPath = Path.Combine(Environment.CurrentDirectory, "Data", Path.Combine(AppDomain.CurrentDomain.BaseDirectory + "recommendation-ratings-test.csv"));
